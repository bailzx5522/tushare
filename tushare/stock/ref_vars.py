...
LHB_SINA_URL2 = '%s%s/q/api/jsonp.php/var details=/InvestConsultService.getLHBComBSData?symbol=%s&tradedate=%s'
...
LHB_TMP_DETAIL_COLS = ['SYMBOL', 'type', 'comCode', 'comName', 'buyAmount', 'sellAmount', 'netAmount'] # no idea about type
LHB_DETAIL_COLS = ['code', 'type', 'insCode', 'insName', 'bamount', 'samount', 'net'] # type: buy/sell
